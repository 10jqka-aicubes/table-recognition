...
class TextDetector:
    ...
    def predict(self, image_path):
        ...
        bboxes, polys, score_text = test_net(
            self.net, image, self.text_threshold, self.link_threshold, self.low_text, self.cuda, self.poly, refine_net
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--refiner_model", default="weights/craft_refiner_CTW1500.pth", type=str, help="pretrained refiner model"
    )
